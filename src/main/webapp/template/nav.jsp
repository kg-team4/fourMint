		...
		<div class="nav-menu">
			<ul>
				...
				<li class="medium-menu">
					...
					<ul>
						<li><a href="communityDetailList.do?count=3&big_no=소식">소식</a></li>
						<li><a href="communityDetailList.do?count=3&big_no=질문">질문</a></li>
						<li><a href="communityDetailList.do?count=3&big_no=모임">모임</a></li>
						<li><a href="communityDetailList.do?count=3&big_no=맛집">맛집</a></li>
						<li><a href="communityDetailList.do?count=3&big_no=분실센터">분실센터</a></li>
						<li><a href="communityDetailList.do?count=3&big_no=사진전">사진전</a></li>
					</ul>
				</li>
