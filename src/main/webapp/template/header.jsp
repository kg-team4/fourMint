...
<body>
	<header>
		...
		<div class="search">
			<form action="../board/used_all_post_list.jsp" method="get"
				style="border: 1px solid white;">
				<input type="hidden" name="type" value="post_title"> <input
					type="text" class="search-bar" name="keyword"
			...
			<ul>
				<c:choose>
					...
					<c:otherwise>
						...
						<li><button id="btn_mint_talk">
								<img src="../img/shopping-cart.png" style="height: 18px; width: 20px">
							</button></li>
						<li><button id="btn_mint_talk" onclick="location.href='./message_list.do'">
