		...
		<div id="map-area">
			<div class="map_wrap">
				...
				<div class="map_category">
					<ul>
						<li><img id="ruler" src="../img/ruler.png"
							onmouseover="this.src='../img/ruler_hover.png'"
							onmouseout="this.src='../img/ruler.png'" onclick="rulerStatus()">
						</li>
						<li><img id="marker" src="../img/marker.png"
							onmouseover="this.src='../img/marker_hover.png'"
							onmouseout="this.src='../img/marker.png'"
							onclick="markerStatus()"></li>
						<li><img id="radius" src="../img/radius.png"
							onmouseover="this.src='../img/radius_hover.png'"
							onmouseout="this.src='../img/radius.png'"
