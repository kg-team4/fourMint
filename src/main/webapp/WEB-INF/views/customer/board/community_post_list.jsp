...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/user/css/community_post_list.css">
					...
					<tr>
						<td id="news_title">
							<div id="news_title_content">
								<img src="${pageContext.request.contextPath}/resources/user/img/megaphone.png" width=25px; height=25px> 
			...
			<div class="store_review">
				<table>
					...
					<tr>
						<td id="news_title">
							<div id="news_title_content">
								<img src="${pageContext.request.contextPath}/resources/user/img/question_mark.png" width=20px; height=20px;>
								<a id="news_title_detail" href="/communityBoard.do?seq=${list.community_seq }">${list.title }</a>
							</div>
						</td>
						<td id="news_useful">
							<div>
								<img src="${pageContext.request.contextPath}/resources/user/img/raise-your-hand-to-ask.png" width=18px;
			...
			<div class="store_review">
				<table>
					...
					<tr>
						<td id="news_title">
							<div id="news_title_content">
								<img src="${pageContext.request.contextPath}/resources/user/img/find.png" width=20px; height=20px;>
								<a id="news_title_detail" href="/communityBoard.do?seq=${list.community_seq }">${list.title }</a>
							</div>
						</td>
						<td id="news_useful">
							<div>
								<img src="${pageContext.request.contextPath}/resources/user/img/sad_icon.png" width=18px;
									height=18px> <span>${list.likes }</span>
							</div>
						</td>
						<td id="news_views">
