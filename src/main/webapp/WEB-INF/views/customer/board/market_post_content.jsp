			...
			<div class="right-item60 left-font padding-left35 col-sm-3">
				...
				<div class="item font17 gray-font padding25">
					...
					<span class="padding-left05"> 
						<img src="${pageContext.request.contextPath}/resources/user/img/time.png" width="15" height="13" alt="시간 아이콘"> &nbsp;<fmt:formatDate pattern="yyyy-MM-dd" value="${content.date }" />
					</span> 
					<span style="float: right; cursor: pointer"> 
						<a class="police_click"> 
							<img src="${pageContext.request.contextPath}/resources/user/img/police.png" width="20" height="20">&nbsp;신고하기
						</a>
					</span>
				</div>
				<div id="police_modal">
										...
										<c:choose>
											<c:when test="${fol eq 0 }">
												<button id="btn_follow" style="width: 100px; display: block">
													<img height="13px" width="13px" src="${pageContext.request.contextPath}/resources/user/img/following_icon.png">&nbsp;팔로우
												</button>
												<button id="btn_unfollow" style="width: 100px; display: none">
													<img height="13px" width="13px" src="${pageContext.request.contextPath}/resources/user/img/following_icon.png">&nbsp;언팔로우
												</button>
											</c:when>
											<c:otherwise>
