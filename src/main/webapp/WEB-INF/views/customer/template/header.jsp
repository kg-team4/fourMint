...
<link href="${pageContext.request.contextPath}/resources/user/css/1.header.css" type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/user/css/2.nav.css" type="text/css" rel="stylesheet">
...
<link href="${pageContext.request.contextPath}/resources/user/css/5.footer.css" type="text/css" rel="stylesheet">
<script src="${pageContext.request.contextPath}/resources/user/js/jquery-3.6.0.min.js"></script>
</head>
<body>
	<header>
		<div class="logo">
			<a href="home.do"><img src="${pageContext.request.contextPath}/resources/user/img/mintmarket_logo.png"></a>
		</div>
		<div class="search">
					...
					<c:otherwise>
						...
						<li>
							<button id="btn_mint_cart" onclick="location.href='payment.do?chk=first'">
								<img src="${pageContext.request.contextPath}/resources/user/img/shopping-cart.png" style="height: 18px; width: 20px">
							</button>
						</li>
						<li>
							<button id="btn_mint_talk" onclick="location.href='./message_list.do'">
								<img src="${pageContext.request.contextPath}/resources/user/img/message.png" style="height: 18px; width: 20px">
							</button>
						</li>
					</c:otherwise>
				</c:choose>
