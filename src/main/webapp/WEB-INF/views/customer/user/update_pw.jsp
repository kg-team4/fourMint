...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/user/js/password.js"></script>
<link href="${pageContext.request.contextPath}/resources/user/css/12.find_pw_result.css" rel="stylesheet"
	type="text/css">
<article id="full-article">
	<div class="main-form">
		<div style="height: 150px;">
			<img src="${pageContext.request.contextPath}/resources/user/img/mt_happy_buying.png" alt="logo_icon" id="logo_icon">
		</div>
		<div id="find-form">
			<div class="id-find">
				<div class="title">
