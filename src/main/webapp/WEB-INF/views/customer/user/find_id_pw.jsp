...
<link href="${pageContext.request.contextPath}/resources/user/css/10.find_id_pw.css" rel="stylesheet"
	type="text/css">
        ...
        <div id="find-form">
	        <div class="id-find">
	            ...
	            <form action="find_id.do" method="post">
	            	<div>
	            		<span><img src="${pageContext.request.contextPath}/resources/user/img/" alt=""></span>
