...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/user/js/join.js"></script>
			...
			<div id="selectAgree">
				<div>
					<input type="checkbox" id="first" class="selectBox" required="required"
						...
						src="${pageContext.request.contextPath}/resources/user/img/arrow-204-32.png" onclick="termsSwitch(1);">
				</div>
				<div class="terms">
				...
				<div>
					<input type="checkbox" id="second" class="selectBox" required="required"
						...
						src="${pageContext.request.contextPath}/resources/user/img/arrow-204-32.png" onclick="termsSwitch(2);">
				</div>
				<div class="terms">
				...
				<div>
					<input type="checkbox" id="third" class="selectBox"> <label
						...
						수신 동의</label> <img src="${pageContext.request.contextPath}/resources/user/img/arrow-204-32.png" onclick="termsSwitch(3);">
				</div>
				<div class="terms">
