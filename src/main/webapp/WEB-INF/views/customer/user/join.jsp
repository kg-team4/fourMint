...
<article class="join-article" style="margin-bottom: 350px">
	<form action="joinProc.do" method="post" class="join-form" id="frm">
		...
		<div class="email-form" style="border-bottom: 1.5px solid rgba(0, 0, 0, 0.41)">
			<input type="text" name="email" placeholder="이메일" id="email"
				 required="required" autofocus="autofocus" oninput="checkId()" style="margin-left: -13px"> <span style="color: gray;">@</span>
		...
		<div style="width:1200px; text-align: center">
			<div style="margin-top:10px; margin:auto;">
				<span style="margin-left:440px; text-align:center"class="point successEmailCheck">&emsp;&emsp;&emsp;&emsp;이메일 입력 후 인증발송 선택 및 인증확인을 눌러주세요</span>
				<span style="margin-left:82px">
					<input style=" font-size:14px;" type="button" class="emailDoubleCheck" id="emailCheck2" value="인증확인" disabled>
				</span>
			</div>			
		</div>
		...
		<div style="margin-top:10px;">
			<span class="point successPhoneCheck">휴대폰 번호 입력 후 문자인증 및 인증확인을 선택하세요</span>
		</div>
			...
			<div id="selectAgree">
				<div>
					<input type="checkbox" id="first" class="selectBox" required="required"
						> <label for="first"><a
						style="color: red;">(필수)</a> 민트마켓 이용약관 동의</label> <img
...
2) 시행일자 : 2018년 05월 01일 
				...
				<div class="terms">
					<textarea readonly>
개인정보보호법 제22조 제4항에 의해 선택정보 사항에 대해서는 기재하지 않으셔도 
서비스를 이용하실 수 있습니다.						
① 마케팅 및 광고에의 활용
 – 신규 기능 개발 및 맞춤 서비스 제공
 – 뉴스레터 발송, 새로운 기능(제품)의 안내
 – 할인 및 쿠폰 등 이벤트 등 광고성 정보 제공							
② 클라썸 서비스를 운용함에 있어 각종 정보를 서비스 화면, SMS, 이메일 등의 방법으로
회원에게 제공할 수 있으며, 결제안내 등 의무적으로 안내되어야 하는 
정보성 내용 및 일부 혜택성 정보는 수신동의 여부와 무관하게 제공합니다.
					</textarea>
				</div>
			</div>
