...
<head>
  ...
  <title>민트 마켓 위치기반서비스 이용약관</title>
  <meta charset="UTF-8">
...
<body>
  <div class="page-content" style="border: #50b9abd0 1px solid; border-radius: 10px; margin-top:20px; padding-bottom:20px;">
    <div class="wrapper">
      <h1>🌲위치기반서비스 이용약관🌲</h1>

<h3>제1조 (목적)</h3>

<p>본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 주식회사 민트
  마켓(이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리・의무 및 책임사항을 규정함을 목적으로 합니다.</p>
...
<ol>
<li>본회사는 아래와 같은 경우에는 여러분의 민트
  마켓 계정 생성을 유보할 수 있습니다.
...
<ol>
<li>종류 : 동네 커뮤니티 서비스</li>
<li>서비스명 : 민트
  마켓</li>
<li>설명 : 내동네를 인증하고 주변 이웃과 중고물품을 거래하거나 동네 정보를 공유하는 서비스</li>
<li>위치정보 이용 목적: 내동네 인증</li>
<li>이용 요금 : 무료</li>
</ol>
</li>
</ol>
...
<li>상호 : 주식회사 민트
  마켓</li>
<li>대표 : 이민트, 이민트</li>
<li>주소 : 서울특별시 구로구 디지털로 30길 28 609호 (민트
  서비스)</li>
<li>대표전화 : 1644-0000</li>
</ul>
</li>
...
<p>제1조 (시행일) 본 약관은 2021년 10월 20일부터 시행합니다.</p>
