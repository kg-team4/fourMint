					...
					<main>
						<div class="container-fluid px-4" id="contents">
							<div class="card mb-4"
								...
								<input type="hidden" id="chartType2" value="bar">
								...
								<div id="ex2">
									...
									<div id="chartAll" style="display: flex;">
										<div id="chart1" class="card-body">
											<canvas id="myChart" width="1%"></canvas>
										</div>
										<div id="chart2" class="card-body">
									...
									<div class="card mb-4"
										...
										<div class="form-check" style="display: flex;">
											...
											<div class="form-check form-check-inline">
												...
												<label class="form-check-label" for="flexRadioDefault2">월
													별</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
													name="date_term" id="flexRadioDefault3" value="year">
												<label class="form-check-label" for="flexRadioDefault3">년
													별</label>
											</div>
										</div>
