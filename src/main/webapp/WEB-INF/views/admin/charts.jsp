...
<script>
		$(document).ready(function() {
			$('#savePdf1').click(function() { // pdf저장 button id
				
			    html2canvas($('#page-content')[0]).then(function(canvas) { //저장 영역 div id
...
<script>
		$(document).ready(function() {
			$('#savePdf2').click(function() { // pdf저장 button id
