		...
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="col-6 offset-2 div_modify_profile">
							...
							<div>
								<table id="my_info_edit_area">
									...
									<tr>
										...
										<td colspan="2"><input type="text" style="width: 90px" placeholder="우쭈쭈동동">
					...
					<button type="button" style="width: 135%; font-size: 15px" class="btn btn--blue-2 btn--radius-2 btn_modify_profile" id="popup_open_btn">내 정보 수정하기</button>
				</div>
			</div>
			<!--/col-3-->
