...
<article style="padding-top: 200px; margin: 0px 20%">
	...
	<div align="left">
		<h2 style="font-size: 30px; margin: 15px;">
			<span style="color: orange">내용</span> 상품목록
		</h2>
		<hr class="hr_style1">
	</div>
	...
	<div align="left">
		<div class="box">
					...
					<div class="product_info">
						...
						<div class="product_like">
							♥ 좋아요&nbsp; <img
								...
								width="17" height="12" alt="상품 상태 아이콘"> 1
						</div>
					</div>
				</div>
			...
			<div class="row center pagination">
				<a href="used_post_list.jsp?page=1&board_no=1&used_cate_num=1">&lt;</a>
				...
				<a href="used_post_list.jsp?page=1&board_no=1&used_cate_num=1">1</a>
			</div>
		</div>
	</div>
</article>
