...
<article style="padding-top: 220px; padding-bottom: 100px"
	id="post-content-form">
	<input type="hidden" value="회원" id="login-member"> <input
		type="hidden" value="1" id="post-member">
		...
		<div class="float-box float-left row">
			...
			<div class="right-item60 left-font padding-left35 col-sm-3">
				...
				<div class="item font17 gray-font padding25">
					<span class="lightgray-font">♥</span> <span
						class="font15 padding-right05">&nbsp;1</span> <span
						class="short-border"> <img
					...
					</span> <span class="padding-left05"> <img src="../img/time.png"
						width="15" height="13" alt="시간 아이콘"> &nbsp;${date }
					</span> 
						...
						<div>
							...
							<div class="police_category">
								...
								<select id="police_reason" name="police_reason">
									...
									<option value="advertisement">광고 (상점 및 타사이트 홍보, 상품도배)</option>
									<option value="product_info_incorrect">상품 정보 부정확 (상품명,
										이미지, 가격, 태그 등)</option>
									<option value="transmit_ban">거래 금지 품목</option>
									<option value="fraud_suspiction">사기의심(외부채널 유도)</option>
									<option value="etc">기타(사유)</option>
								</select>
							</div>
							<div class="write_police_reason">
								<textarea style="border:1px solid lightgray" rows="5" cols="5"></textarea>
							</div>
							<br>
				...
				<div class="item font15 padding15">
					...
					<div class="padding15">
						<span class="gray-font">&middot; 거래지역</span><span
							class="green-font">&emsp;${content.address2}</span>
					</div>
				</div>
						...
						<c:choose>
							<c:when test="${nickname eq content.nickname }">
								<div class="left-item33">
									<a
										href="../member/check.jsp?go=myweb/bo1ard/usedpostdelete.do?post_no=1"><button
											class="delete-button cursor">삭제</button></a>
								</div>
							</c:when>
							<c:when
								test="${nickname ne content.nickname and nickname ne null}">
								<div class="left-item33">
						...
						<div class="padding-top30">
							<div class="float-box float-left">
								<div class="left-item25  pic-align left-font">
									<a href="#"> <img class="reply-pic-circle"
										src="../img/baking.png">
									</a>
								</div>
						...
						<div class="tabcontent">
							...
							<div id="tab02">
								<div class="community_post_record">
									<table >
										<tr >
											<td style="text-align:center; padding:8px;"><div class="community_category">분실센터</div>&nbsp;</td>
											<td style="text-align:center; padding:8px;"><div class="community_title">묘동 스타벅스 사거리에서 에어팟을 잃어버렸어요ㅠㅠ</div>&nbsp;</td>
											<td style="text-align:center; padding:8px;"><div class="community_date">2021.11.16</div>&nbsp;</td>
										</tr>
									</table>
								</div>
								<hr>
								<div class="community_no_post">
									작성한 커뮤니티 글이 없습니다.
								</div>
							...
							<div id="tab03">
									...
									<table width="100%" height="140">
										<tr>
											<td width="20%" rowspan="2" style="padding:10px" >
												<div id="img_box">
													<a id="market_review_img_area" href="#"> <img
								...
								<div class="store_review">
									<table width="100%" height="120">
										<tr height="30">
											<td width="20%" rowspan="2" style="padding:10px"><a
												id="market_review_img_area" href="#">
													<div id="img_box">
										...
										<tr>
											<td align="left" colspan="4" style="font-size: 15px">
												...
												<div id="sold_product_review">빠른 쿨거래 해주셔서 너무
													좋았어요!나불나불나불나불나불어찌고저찌고저찌고나불나불나불나불나불어찌고저찌고저찌
													좋았어요!나불나불나불나불나불어찌고저찌고저찌고나불나불나불나불나불어찌고저찌고저찌
												</div>
											</td>
										</tr>
					...
					<div class="float-box float-left">
						...
						<div class="right-item75">
							<div class="top-margin10 left-font seller">
								...
								<div id="member-form">
									<div>
										<a class="seller_nick" style="cursor: pointer">우쭈쭈동동</a>
									</div>
									<div class="seller_grade">
										<img src="../img/star_rank.png" width="13" height="12"
											alt="별점이미지"> <img src="../img/star_rank.png" width="13"
											height="12" alt="별점이미지"> <img
											src="../img/star_rank.png" width="13" height="12" alt="별점이미지">
										<img src="../img/star_rank.png" width="13" height="12"
											alt="별점이미지"> <img src="../img/star_rank.png" width="13"
											height="12" alt="별점이미지">
									</div>
									<div id="proudct_num_follower">
										상품 &nbsp;<span>23</span> &emsp; 팔로워 &nbsp;<span>88</span>
									</div>
									<button id="btn_follow" style="width: 100px">
										<img height="13px" width="13px"
											src="../img/following_icon.png">&nbsp;팔로우
									</button>
								</div>
							</div>
						</div>
						...
						<div class="right-item75">
							<div class="top-margin10 left-font seller">
								...
								<div id="member-form">
									...
									<div id="buyer_review">너무 친절하셔서 좋았어여!! 다음에 또 거래하고 싶어요!!
										좋은하루되세요~!! 뭐지뭐지뭐지뭐뭐지</div>
						...
						<div class="right-item75">
							<div class="top-margin10 left-font seller">
								...
								<div id="member-form">
									...
									<div id="buyer_review">직거래 바로 해주셔서 감사합니다. 룰룰루 잘 사용할게요 항상
										좋은 하루 보내세용~!!!!</div>
									<button id="btn_follow" style="width: 100px">상품후기 더보기</button>
								</div>
							</div>
