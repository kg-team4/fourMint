					...
					<div id="tab01">
						<div class="store_review_all">
							<div class="store_review">
								<table>
									<tr>
										<td id="news_num"><img src="../img/megaphone.png"
											width=23px; height=23px></td>
										<td id="news_title">
											<div id="news_title_content">
												<a id="news_title_detail" href="#">민트스토어 택배없는 날 관련 배송 지연
													안내</a>
											</div>
										</td>
									...
									<tr id="contents" style="display: none">
										...
										<td>
											<div style="text-align: right">2020-08-14</div> <pre>
												<br>							
안녕하세요.
